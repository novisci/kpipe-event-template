 ...
 */
function FieldSpecifier(tableBasePath) {
    let deprecatedWarning = false;
    const tables = {};
    function lookupTable(tableName, key) {
        ...
        if (fld.type && v) {
            switch (fld.type) {
                ...
                case 'number':
                    ...
                    break;
                case 'ymdate':
                    v = `${v.substring(0, 4)}-${v.substring(4)}-15`;
                    break;
                case 'nodecimal':
                ...
                case 'trimdecimal':
                    ...
                    break;
                case 'npi':
                    v = v.length > 5 ? v : null; // Only pass valid NPIs, otherwise null
                    break;
                case 'fromDateString':
...
//# sourceMappingURL=field-specifier.js.map